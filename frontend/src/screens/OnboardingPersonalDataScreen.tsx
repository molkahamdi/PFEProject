// ============================================================
//  frontend/screens/OnboardingPersonalDataScreen.tsx — FINALE
//  ✅ Création normale | ✅ Modification fromRecap (pré-rempli)
//  ✅ E-Houwiya auto-fill | ✅ Style original conservé
// ============================================================
...
const OnboardingPersonalDataScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  const handleContinue = async () => {
    ...
    try {
      if (fromRecap && customerId) {
        // ✅ MODE MODIFICATION — updateCustomer puis retour Récap
        ...
        Alert.alert('✅ Modifications enregistrées', 'Vos informations ont été mises à jour avec succès.', [
        ...
        // ✅ MODE CRÉATION — createCustomer puis OTP
          ...
          <View style={styles.content}>
            ...
            <View style={styles.titleSection}>
              <View style={styles.titleHeader}>
                <View>
                  <Text style={styles.pageNumber}>{fromRecap ? 'MODIFICATION' : 'ÉTAPE 01/05'}</Text>
              ...
              <View style={styles.progressContainer}>
                <View style={styles.progressBarBackground}>
                  <LinearGradient colors={[colors.atb.red, colors.atb.red]} style={[styles.progressBarFill, { width: fromRecap ? '100%' : '20%' }]} />
                </View>
                <Text style={styles.progressText}>{fromRecap ? '100%' : '20%'}</Text>
              </View>
            </View>

            {!fromRecap && (
              <View style={styles.stepIndicatorContainer}>
                <StepIndicator currentStep={1} steps={['Données personnelles','Documents Justificatifs','Récapitulatif','Envoi de la demande','Signature électronique']} />
              </View>
            )}
              ...
              <View style={styles.formSection}>
                ...
                <View style={styles.fieldContainer}>
                  ...
                  <View style={styles.inputContainer}>
                    <TextInput style={styles.singleInput} placeholder="Votre nom" placeholderTextColor={colors.neutral.gray400} value={formData.lastName} onChangeText={t => updateField('lastName', t)} selectionColor={colors.atb.primary} />
                  </View>
                </View>
                ...
                <View style={styles.fieldContainer}>
                  ...
                  <View style={styles.inputContainer}>
                    <TextInput style={styles.singleInput} placeholder="Votre prénom" placeholderTextColor={colors.neutral.gray400} value={formData.firstName} onChangeText={t => updateField('firstName', t)} selectionColor={colors.atb.primary} />
                  </View>
                </View>

                <View style={styles.row}>
                  <View style={styles.halfWidth}>
                    <CustomInput label="الاسم العائلي*" placeholder="" value={formData.lastNameArabic} onChangeText={t => updateField('lastNameArabic', t)} style={{ textAlign: 'right' }} />
                  </View>
                  <View style={styles.halfWidth}>
                    <CustomInput label="الاسم الشخصي*" placeholder="" value={formData.firstNameArabic} onChangeText={t => updateField('firstNameArabic', t)} style={{ textAlign: 'right' }} />
                  </View>
                </View>
                ...
                <View style={styles.fieldContainer}>
                  ...
                  <View style={styles.genderRow}>
                    {GENDER_OPTIONS.map(option => (
                      <TouchableOpacity key={option.value} onPress={() => updateField('gender', option.value)}
                        style={[styles.genderButton, formData.gender === option.value && styles.genderButtonSelected]}>
                        <Text style={[styles.genderText, formData.gender === option.value && styles.genderTextSelected]}>{option.label}</Text>
                      </TouchableOpacity>
                    ))}
                  </View>
                </View>
              ...
              <View style={styles.formSection}>
                ...
                <View style={styles.fieldContainer}>
                  ...
                  <View style={styles.phoneRow}>
                    ...
                    <View style={styles.phoneInputContainer}>
                      <TextInput style={styles.phoneInput} placeholder="00 000 000" placeholderTextColor={colors.neutral.gray400} keyboardType="phone-pad" value={formData.phoneNumber} onChangeText={t => updateField('phoneNumber', t)} selectionColor={colors.atb.primary} maxLength={8} />
                    </View>
                  </View>
                </View>
                ...
                <View style={styles.fieldContainer}>
                  ...
                  <View style={styles.emailInputWrapper}>
                    <TextInput style={styles.emailInput} placeholder="exemple@domaine.com" placeholderTextColor={colors.neutral.gray400} keyboardType="email-address" autoCapitalize="none" value={formData.email} onChangeText={t => updateField('email', t)} selectionColor={colors.atb.primary} />
                  </View>
                </View>
              </View>
            </View>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.formSection}>
                ...
                <View style={styles.fieldContainer}>
                  ...
                  <View style={styles.inputContainer}>
                    <TextInput style={styles.singleInput} placeholder="Saisir le numéro CIN" placeholderTextColor={colors.neutral.gray400} value={formData.idCardNumber} onChangeText={t => updateField('idCardNumber', t)} keyboardType="number-pad" selectionColor={colors.atb.primary} maxLength={8} />
                  </View>
                </View>
...
const styles = StyleSheet.create({
  ...
  eHouwiyaBannerText: { fontSize: 13, color: '#16a34a', fontWeight: '500', lineHeight: 18 },
  ...
  titleHeader: { marginBottom: 24 },
  pageNumber: { fontSize: 11, fontWeight: '800', color: colors.atb.red, letterSpacing: 1.5, marginBottom: 10 },
  ...
  stepIndicatorContainer: { marginBottom: 32 },
