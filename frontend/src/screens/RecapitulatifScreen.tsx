...
const RecapitulatifScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  const formatFileStatus = (path?: string) => path ? '✓ Téléchargé' : '✗Manquant';
        ...
        <View style={styles.content}>
          ...
          <View style={styles.titleSection}>
            ...
            <View style={styles.progressBar}>
              <LinearGradient colors={[colors.atb.red, colors.atb.red]} style={[styles.progressFill, { width: '86%' }]} />
            </View>
          </View>
          ...
          <View style={styles.infoBanner}>
            ...
            <Text style={styles.infoBannerText}>
              Vous pouvez modifier chaque section. Vos données précédentes seront pré-remplies automatiquement.
            </Text>
          </View>
          ...
          <Section
            ...
            onEdit={() => {
              // @ts-ignore
              navigation.navigate('DocumentsJustificatif', { customerId, fromRecap: true });
            }}
          >
            <InfoRow label="Type document" value={customer.usePassport ? 'Passeport' : "Carte Nationale d'Identité"} />
...
const styles = StyleSheet.create({
  ...
  progressBar: { height: 4, backgroundColor: colors.neutral.gray200, borderRadius: 2, overflow: 'hidden' },
  ...
  continueGradient: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 54, paddingHorizontal: 20, gap: 10 },
